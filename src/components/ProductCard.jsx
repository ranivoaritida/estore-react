...
const ProductCard = ({product}) => {
  ...
  const productInCard = cartItems.find((items) => items.product.id === product.id);

  const productQuantity = productInCard ? `(${productInCard.quantity})` : "" ;

  return (
    <div className='product-card'>
        <img src="https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=500&h=500&fit=crop" alt={product.name} className='product-image' />
